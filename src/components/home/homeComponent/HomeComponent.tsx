    ...
    <div className="container-fluid mx-0 px-0">
      <div className="row mx-0">
        ...
        <div className="row d-flex align-content-center justify-content-center" >
          <div className="col-11 mt-4 ojo"> 
            <div className="row">
              <div className="col-6 mt-4 p-0">
                <div
                  className="img-index" style={{ backgroundImage: `url(https://resizer.otstatic.com/v2/photos/wide-huge/2/50470822.jpg)` }}
                ></div>
              </div>
              <div className="col-6 mx-0 py-0">
                <div className="row div-text text-fluid d-flex align-content-center">
            ...
            <div className="row">
              ...
              <div className="col-7 p-0">
                <div
                  className="img-index" style={{ backgroundImage: `url(https://img.freepik.com/foto-gratis/madre-e-hija-cocinando-cocina-casa_23-2148805020.jpg)` }}
                ></div>
              </div>
            </div>
          </div>
