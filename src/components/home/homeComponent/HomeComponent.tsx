    ...
    <div className="container-fluid mx-0 px-0">
      <div className="row mx-0">
        ...
        <div className="row d-flex align-content-center justify-content-center" >
          <div className={`col-11 mt-4 d-none d-xl-block ${styles.ojo}`}> 
            <div className="row">
          ...
          <div className={`col-11 mt-4 d-block d-xl-none`}> 
            <div className="row">
              <div className="col-12 mt-4 p-0 d-flex justify-content-center">
                <img className={`${styles.img_lg}`} src="https://resizer.otstatic.com/v2/photos/wide-huge/2/50470822.jpg" alt="" />
              </div>
            ...
            <div className="row">
              <div className="col-12 p-0 d-flex justify-content-center">
                <img className={`${styles.img_lg}`} src="https://img.freepik.com/foto-gratis/madre-e-hija-cocinando-cocina-casa_23-2148805020.jpg" alt="" />
              </div>
              <div className={`col-12 ${styles.div_text}`}>
                <div className="my-4 ">
                  <br></br>
                  <h1 className="text-center">Nuestra misión</h1>
                  <h5>
